import { RadarMath } from './radar-math.js?v=1.1.9';
import { RadarUI } from './radar-ui.js?v=1.1.9';
import { RadarRenderer } from './radar-renderer.js?v=1.1.9'; 
import { RadarEditor } from './radar-editor.js?v=1.1.9';
const CARD_I18N = {
